...
class Precision(CumulativeMetric):
    ...
    def add_recommendations(self, is_relevant, pos_items):
        ...
        self.metric_per_user.append(precision)
        self.cumulative_metric += precision
        self.n_users += 1
...
class MAP(CumulativeMetric):
    ...
    def add_recommendations(self, is_relevant, pos_items):
        ...
        self.metric_per_user.append(mapval)
        self.cumulative_metric += mapval
        self.n_users += 1
...
class ARHR(CumulativeMetric):
    ...
    def add_recommendations(self, is_relevant, pos_items):
        ...
        arhr = is_relevant.dot(p_reciprocal)
        self.metric_per_user.append(arhr)
        self.cumulative_metric += arhr
        self.n_users += 1
...
class ROC_AUC(CumulativeMetric):
    ...
    def add_recommendations(self, is_relevant, pos_items):
        ...
        self.metric_per_user.append(auc_score)
        self.cumulative_metric += auc_score
        self.n_users += 1
...
class Recall(CumulativeMetric):
    ...
    def add_recommendations(self, is_relevant, pos_items):
        ...
        self.metric_per_user.append(recall)
        self.cumulative_metric += recall
        self.n_users += 1
...
class MRR(CumulativeMetric):
    ...
    def add_recommendations(self, is_relevant, pos_items):
        ...
        self.metric_per_user.append(rr)
        self.cumulative_metric += rr
        self.n_users += 1
...
class NDCG(CumulativeMetric):
    ...
    def add_recommendations(self, ranked_list, pos_items, relevance=None, at=None):
        ...
        self.metric_per_user.append(ndcg_)
        self.cumulative_metric += ndcg_
        self.n_users += 1
...
class F1(CumulativeMetric):
    ...
    def add_recommendations(self, is_relevant, pos_items):
        ...
        if precision + recall > 0:
            ...
            f1 = 0.
        self.metric_per_user.append(f1)
        self.cumulative_metric += f1
        self.n_users += 1
...
class HIT_RATE(CumulativeMetric):
    ...
    def add_recommendations(self, is_relevant, pos_items):
        ...
        self.metric_per_user.append(hr)
        self.cumulative_metric += hr
        self.n_users += 1
...
class RMSE(CumulativeMetric):
    ...
    def add_recommendations(self, predicted_ratings, relevant_items, relevant_items_rating):
        relevant_items_predictions = predicted_ratings[relevant_items]
        ...
        self.metric_per_user.append(rmse)
        self.cumulative_metric += rmse
        self.n_users += 1
...
def average_precision(is_relevant, pos_items):
    if len(pos_items) > 0:
        ...
        a_p = np.sum(p_at_k) / np.min([len(pos_items), is_relevant.shape[0]])
