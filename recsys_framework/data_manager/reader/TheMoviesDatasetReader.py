...
from recsys_framework.data_manager.utils import removeFeatures
from recsys_framework.data_manager.dataset_postprocessing import KCore

from recsys_framework.utils import reshapeSparse, IncrementalSparseMatrix_FilterIDs, invert_dictionary
...
class TheMoviesDatasetReader(DataReader):
    ...
    MANDATORY_POSTPROCESSINGS = [KCore(user_k_core=1, item_k_core=1)]
