...
from recsys_framework.data_manager.reader.AmazonReviewDataReader import AmazonReviewDataReader
...
class AmazonElectronicsReader(AmazonReviewDataReader):
    ...
    def _load_from_original_file(self):
        ...
        self._load_from_original_file_all_amazon_datasets(URM_path, metadata_path=metadata_path, reviews_path=None)
