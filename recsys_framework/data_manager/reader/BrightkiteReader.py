...
from recsys_framework.data_manager.utils import downloadFromURL
...
class BrightkiteReader(DataReader):
    ...
    def __init__(self, reload_from_original_data=False):
        super(BrightkiteReader, self).__init__(reload_from_original_data)
    ...
    def _load_from_original_file(self):
        ...
        URM_all, item_mapper, user_mapper = self._loadURM(URM_path, separator="\t", header=False)
