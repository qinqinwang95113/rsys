...
from recsys_framework.data_manager.utils import downloadFromURL, load_CSV_into_SparseBuilder
...
class EpinionsReader(DataReader):
    ...
    def _load_from_original_file(self):
        ...
        URM_all, item_mapper, user_mapper = load_CSV_into_SparseBuilder(decompressed_file_path, separator=" ", header=True)
