...
from .dataset_splitter import DataSplitter
...
class LeaveKOut(DataSplitter):
    ...
    def __init__(self, k_value=1, forbid_new_split=False, force_new_split=False, with_validation=True,
                 test_rating_threshold=0, random_seed=42):
        """
    ...
    def split(self, dataset):
        ...
        if not self.allow_cold_users:
            ...
            print("DataSplitterLeaveKOut: Removing {} of {} users because they have less than the {} interactions required for {} splits".format(
                    URM.shape[0] - len(users_to_preserve), URM.shape[0], min_user_interactions, split_number))
