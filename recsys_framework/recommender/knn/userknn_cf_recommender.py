...
from recsys_framework.recommender import UserSimilarityMatrixRecommender
from recsys_framework.utils import check_matrix

from recsys_framework.utils.feature_weighting import okapi_BM_25, TF_IDF
...
class UserKNNCF(UserSimilarityMatrixRecommender):
    ...
    def load_model(self, folder_path='', file_name=None, gui=False):
        ...
        super(UserKNNCF, self).load_model(folder_path=folder_path, file_name=file_name)