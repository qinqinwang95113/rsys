...
from recsys_framework.recommender import SimilarityMatrixRecommender


class ItemKNNCustomSimilarity(SimilarityMatrixRecommender):
    """ ItemKNN recommender"""

    RECOMMENDER_NAME = "ItemKNNCustomSimilarity"
